        ...
        <div class="col-sm-6 col-lg-4">
            <div class="card h-100 shadow-sm border-0 rounded-4 overflow-hidden">
                ...
                <div class="card-body p-4 d-flex flex-column">
                    <h5 class="card-title fw-bold">Nike Dunk Low</h5>
                    <p class="card-text text-body-secondary small">El icono del basquetbol de los 80, que se creó
                        para la cancha pero conquistó
                        las calles...</p>
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 g-4">
        <div class="col">
            <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden">
                <img src="<?php echo $imagen_zapatilla_1; ?>"
                    class="card-img-top p-3 bg-white" alt="<?php echo $alt_imagen_1; ?>">
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <button class="btn btn-outline-dark rounded-pill mt-auto" data-bs-toggle="modal"
                        data-bs-target="#detallesModal" data-zapatilla="<?php echo $data_zapatilla_1; ?>">Ver Detalles</button>
                </div>
            </div>
        </div>
        <div class="col">
